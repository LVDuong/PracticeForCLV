...
*@FileName : LogManagementDBDAOComIntgCdRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogManagementDBDAOComIntgCdRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LogManagementDBDAOComIntgCdRSQL
	  * </pre>
	  */
	public LogManagementDBDAOComIntgCdRSQL(){
		setQuery();
		...
		query.append("FileName : LogManagementDBDAOComIntgCdRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}

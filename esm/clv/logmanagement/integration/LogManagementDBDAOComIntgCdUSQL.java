...
*@FileName : LogManagementDBDAOComIntgCdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogManagementDBDAOComIntgCdUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LogManagementDAOLogUSQL
	  * </pre>
	  */
	public LogManagementDBDAOComIntgCdUSQL(){
		setQuery();
		...
		query.append("FileName : LogManagementDBDAOComIntgCdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}

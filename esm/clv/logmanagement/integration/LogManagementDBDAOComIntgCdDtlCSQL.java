...
*@FileName : LogManagementDBDAOComIntgCdDtlCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogManagementDBDAOComIntgCdDtlCSQL implements ISQLTemplate{
	...
	public LogManagementDBDAOComIntgCdDtlCSQL(){
		...
		query.append("FileName : LogManagementDBDAOComIntgCdDtlCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}

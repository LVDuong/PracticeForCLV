...
*@FileName : LogManagementDBDAOsearchDupChkCodeMgmtDtlRSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogManagementDBDAOsearchDupChkCodeMgmtDtlRSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LogManagementDBDAOsearchDupChkCodeMgmtDtlRSQL
	  * </pre>
	  */
	public LogManagementDBDAOsearchDupChkCodeMgmtDtlRSQL(){
		setQuery();
		...
		query.append("FileName : LogManagementDBDAOsearchDupChkCodeMgmtDtlRSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}

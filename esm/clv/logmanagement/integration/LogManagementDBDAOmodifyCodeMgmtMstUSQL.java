...
*@FileName : LogManagementDBDAOmodifyCodeMgmtMstUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogManagementDBDAOmodifyCodeMgmtMstUSQL implements ISQLTemplate{
	...
	/**
	  * <pre>
	  * LogManagementDBDAOmodifyCodeMgmtMstUSQL
	  * </pre>
	  */
	public LogManagementDBDAOmodifyCodeMgmtMstUSQL(){
		setQuery();
		...
		query.append("FileName : LogManagementDBDAOmodifyCodeMgmtMstUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}

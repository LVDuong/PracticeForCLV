...
*@FileName : LogMgmtCondVO.java
*@FileTitle : LogMgmtCondVO
*Open Issues :
*Change history :
...
public class LogMgmtCondVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<LogMgmtCondVO> models = new ArrayList<LogMgmtCondVO>();
	...
	public LogMgmtCondVO() {}

	public LogMgmtCondVO(String ibflag, String pagerows, String codeid, String codeVal, String subsystem, String searchtype, String searchCdTp) {
	 ...
	 */
	public LogMgmtCondVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return LogMgmtCondVO[]
	 */
	public LogMgmtCondVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		LogMgmtCondVO model = null;
	 ...
	 * @return LogMgmtCondVO[]
	 */
	public LogMgmtCondVO[] getLogMgmtCondVOs(){
		LogMgmtCondVO[] vos = (LogMgmtCondVO[])models.toArray(new LogMgmtCondVO[models.size()]);
		return vos;
	}

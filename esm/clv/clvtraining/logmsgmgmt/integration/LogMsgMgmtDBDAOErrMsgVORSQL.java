...
*@FileName : LogMsgMgmtDBDAOErrMsgVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class LogMsgMgmtDBDAOErrMsgVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public LogMsgMgmtDBDAOErrMsgVORSQL(){
		setQuery();
		...
		query.append("FileName : LogMsgMgmtDBDAOErrMsgVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}

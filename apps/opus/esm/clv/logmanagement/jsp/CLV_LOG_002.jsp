...
<%@ page import="com.clt.apps.opus.esm.clv.logmanagement.event.LogManagementEvent"%>
<%
	LogManagementEvent event = null; //PDTO(Data Transfer Object including Parameters)
	...
	try {
		event = (LogManagementEvent)request.getAttribute("Event");

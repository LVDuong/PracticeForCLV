...
<%@ page import="com.clt.apps.opus.esm.clv.moneymgmt.event.Practice0003Event"%>
...
<script language="javascript" type="text/javascript" src="apps/opus/esm/clv/moneymanagement/script/CoMoneyMgmt.js"></script>
<form name="form">
	...
	<div class="page_title_area clear">
		<!-- page_title(S) -->
		<h2 class="page_title"><button type="button"><span id="title">PRACTICE_0003</span></button></h2>
		<!-- page_title(E) -->
		<!-- opus_design_btn(S) -->

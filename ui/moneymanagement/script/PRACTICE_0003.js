    ...
    switch (sAction) {
        case IBSEARCH: // retrieve
            ...
            if (!isDbClick) {
                ...
                var xml = sheetObj.GetSearchData("PRACTICE_0003GS.do", FormQueryString(formObj));
                sheetObj.LoadSearchData(xml, { Sync: 1 });
            } else {
                searchDetail = searchSummary;
                var xml = sheetObj.GetSearchData("PRACTICE_0003GS.do", searchForDbl);
                sheetObj.LoadSearchData(xml, { Sync: 1 });
            }
